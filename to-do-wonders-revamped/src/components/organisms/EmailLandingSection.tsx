...
interface EmailLandingSectionProps {
  onOptionSelect: (option: string) => void;
}

export default function EmailLandingSection({ onOptionSelect }: EmailLandingSectionProps) {
  const gmailOption = {
    title: "Use Gmail",
      ...
      <div className="feature-comparison">
        ...
        <div className="comparison-table">
          <div className="comparison-row">
            ...
            <div className="gmail-feature">Gmail</div>
            <div className="pro-feature">AI Pro</div>
          </div>
          <div className="comparison-row">
